...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x16rpc_verify_email.proto2\xe3\x04\n" +
	"\n" +
	...
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"V\x92A;\x12\fVerify email\x1a+Use this API to verify user's email address\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x83\x01\x92A\\\x12Z\n" +
	"\x0fSimple Bank API\"B\n" +
	"\n" +
	"Raju Putra\x12\x1chttps://github.com/rajuputra\x1a\x16rajuputratzy@gmail.com2\x031.2Z\"github.com/rajuputra/simplebank/pbb\x06proto3"
