...
// createRandomTransfer membuat transfer antara dua akun yang sudah ada.
...
func TestListTransfers(t *testing.T) {
	...
	// Buat 10 transfer antara dua akun yang sama
	for i := 0; i < 10; i++ {
		createRandomTransfer(t, fromAccount, toAccount)
	}
	...
	for _, transfer := range transfers {
		require.NotEmpty(t, transfer)
		// Pastikan transfer melibatkan setidaknya salah satu akun
		require.True(t,
